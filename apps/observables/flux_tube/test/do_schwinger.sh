...
output_path_electric_trans_l=./result/flux_tube_schwinger_electric_trans_l1
...
d_ouside=10
d_max=10
parameters="--conf_format_plaket ${conf_format_plaket} --file_precision_plaket ${file_precision_plaket} --conf_path_plaket ${conf_path_plaket}\
    --bytes_skip_plaket ${bytes_skip_plaket} --convert_plaket ${convert_plaket}\
    --conf_format_wilson ${conf_format_wilson} --file_precision_wilson ${file_precision_wilson} --conf_path_wilson ${conf_path_wilson}\
...
../flux_tube_schwinger_${matrix_type}_test ${parameters}