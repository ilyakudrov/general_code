...
path_conf_monopole="./result/conf_monopole_16_1001_nocompensate"
path_conf_monopoless="./result/conf_monopoless_16_1001_nocompensate"
...
parameters="-path_conf ${path_conf} -conf_format ${conf_format} -path_conf_monopole ${path_conf_monopole} -path_conf_monopoless ${path_conf_monopoless} \
    ...
    -parallel ${parallel} -compensate_dirac ${compensate_dirac}"
