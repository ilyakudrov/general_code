#!/bin/bash
path_conf="../../../tests/confs/Landau/su3/gluodynamics/24^4/beta6.0/steps_0/copies=20/conf_Landau_gaugefixed_0001_0"
conf_format=qcdstag
file_precision=double
path_conf_monopole="./result/conf_monopole"
path_conf_monopoless="./result/conf_monopoless"
path_inverse_laplacian="../../../tests/confs/inverse_laplacian/ALPHA24x24_d.LAT"
bytes_skip=0
x_size=24
y_size=24
z_size=24
